    ...
    <q-form @submit="handleRegister" class="form-container">
      <div class="name-row">
        <div class="input-group half-width">
          ...
          <div v-if="form.first_name && form.first_name.length < 2" class="error-message">
        ...
        <div class="input-group half-width">
          ...
          <div v-if="form.last_name && form.last_name.length < 2" class="error-message">
      ...
      <div class="input-group">
        ...
        <div v-if="form.confirmPassword && form.confirmPassword !== form.password" class="error-message">
